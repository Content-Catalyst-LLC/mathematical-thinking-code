...
-- Haskell companion scaffold for Proof and the Logic of Mathematical Justification
-- Article folder: proof-logic-mathematical-justification
--
...
articleSlug :: String
articleSlug = "proof-logic-mathematical-justification"
