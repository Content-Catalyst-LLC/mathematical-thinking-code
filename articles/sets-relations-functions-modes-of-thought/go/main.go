...
func main() {
	path := filepath.Join("..", "data", "raw", "mapping_warnings.csv")
	...
	fmt.Println("Mapping warnings by mathematical structure")
	...
	fmt.Println("\nInterpretation: set boundaries, relation definitions, and function mappings require explicit assumptions.")
}
