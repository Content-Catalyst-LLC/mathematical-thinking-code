...
-- Haskell companion scaffold for Patterns, Structure, and the Mathematical Imagination
-- Article folder: patterns-structure-mathematical-imagination
--
...
articleSlug :: String
articleSlug = "patterns-structure-mathematical-imagination"
