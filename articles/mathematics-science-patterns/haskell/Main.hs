...
-- Haskell companion scaffold for Mathematics as the Science of Patterns
-- Article folder: mathematics-science-patterns
--
...
articleSlug :: String
articleSlug = "mathematics-science-patterns"
