...
-- Haskell companion scaffold for What Is Mathematical Thinking?
-- Article folder: mathematical-thinking-pattern-proof-architecture-reason
--
...
articleSlug :: String
articleSlug = "mathematical-thinking-pattern-proof-architecture-reason"
