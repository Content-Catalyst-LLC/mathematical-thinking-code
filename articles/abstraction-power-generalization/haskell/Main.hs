...
-- Haskell companion scaffold for Abstraction and the Power of Generalization
-- Article folder: abstraction-power-generalization
--
...
articleSlug :: String
articleSlug = "abstraction-power-generalization"
